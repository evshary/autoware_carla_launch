...
Now we're using the maps generated by Hatem.
...
```
thread 'main' panicked at /home/aeon/.cargo/registry/src/index.crates.io-6f17d22bba15001f/carla-sys-0.6.0/build.rs:61:10:
called `Result::unwrap()` on an `Err` value: ParseError(AutocxxCodegenError(Conversion(Cpp(UnsupportedType("[u64 ; 4usize]")))))

```

please try using Clang 12.
